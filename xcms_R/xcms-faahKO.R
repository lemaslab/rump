...
option_list = list(
    ...
    make_option(c("-p", "--plot1"), type="character", default="chromatograms_1.pdf", 
              help="the file name and location of the first chromatograms plot", metavar="character"),
    make_option(c("-q", "--plot2"), type="character", default="ion_current.pdf", 
              help="the file name and location of the box plot", metavar="character"),
    make_option(c("-r", "--plot3"), type="character", default="chromatograms_2.pdf", 
...
pdf(opt$plot1)    # add code to plot the figure then save it to file
...
pdf(opt$plot2)    # add code to plot the figure then save it to file
...
pdf(opt$plot3)    # add code to plot the figure then save it to file
