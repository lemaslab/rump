...
if (params.help) {
    ...
    System.out.println("or at https://github.com/lemaslab/ReUMP/issues.")
    System.out.println("Check https://github.com/lemaslab/ReUMP for updates, and refer to")
    System.out.println("https://github.com/lemaslab/ReUMP/wiki")
    System.out.println("")
    System.out.println("Usage:  ")
    System.out.println("   nextflow run_all.nf [options] -with-docker xinsongdu/lemaslab_reump:v0.0.0")
    System.out.println("")
    ...
    System.out.println("")
    System.out.println("ReUMP supports .mzXML format files.")
    System.out.println("")
    exit 1
}
