...
process batchfile_generation_mzmine {
    ...
    shell:
    """   
    python ${batchfile_generator} -x ${params.pos_config} -i ${pos_data_dir} -l $params.library -o $params.pos_mzmine_peak_output &&
    python ${batchfile_generator} -x ${params.neg_config} -i ${neg_data_dir} -l $params.library -o $params.neg_mzmine_peak_output
