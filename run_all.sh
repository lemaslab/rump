...
nextflow run_all.nf --cutoff 0.000004 --pos_mzmine_peak_output pos_data.csv --neg_mzmine_peak_output neg_data.csv -with-singularity docker://galaxydream/metabolomics_pipeline
date
