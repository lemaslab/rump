...
- MZmine is a folder and it is also an input of the pipeline. The MZmine folder in the computer has the same storage address with that under work directory (i.e., if you change something under any of the MZmine folder, the other one will also change).